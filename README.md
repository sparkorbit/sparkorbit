...
- `pipelines/llm_enrich`: local LLM enrichment tooling
...
- `pipelines/llm_enrich`는 별도 오프라인 enrichment tooling이고, homepage summary/digest는 backend session runtime이 담당한다.
