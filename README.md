...
**AI Model Leaderboard** — rankings across Text, Image, Code, Video, and Document side by side.

<p align="center">
  <img src="./docs/images/feature_leaderboard.jpg" alt="AI Model Leaderboard" width="100%"/>
</p>

**Side Panel** — trending models, community feeds, and news from 40+ sources at a glance.

<p align="center">
  <img src="./docs/images/feature_sidepanel.png" alt="Side Panel — models, community, news" width="100%"/>
</p>

<p align="center">
  <img src="./docs/images/feature_sidepanel_company.png" alt="Side Panel — company feeds" width="100%"/>
</p>

**LLM Ready notification** — when local LLM processing completes, a pop-up tells you summaries and paper topics are ready.

<p align="center">
  <img src="./docs/images/feature_llm_ready.png" alt="LLM Ready pop-up" width="400"/>
</p>

**LLM Briefing output** — daily summary generated by local Qwen 3.5 4B.

<p align="center">
  <img src="./docs/images/feature_llm_output.png" alt="LLM briefing output" width="100%"/>
</p>
