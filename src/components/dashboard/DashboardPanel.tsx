...
export function DashboardPanel({
  ...
  return (
    <section className={`${panel} ${riseIn} flex flex-col`} style={style}>
      <div className="flex items-start justify-between gap-2 border-b border-[rgba(124,255,155,0.12)] pb-3">
        <div className="min-w-0 flex-1">
          <p className={label}>{eyebrow}</p>
          <h2 className="font-display mt-2 truncate text-[0.98rem] font-semibold tracking-[-0.03em] text-orbit-text">
            {title}
          </h2>
        </div>
